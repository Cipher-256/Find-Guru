...
<body style="background-color: lightgray;">
	<div class="container" style="min-height: 653px;background-color: white;padding: 0px;">	
		...
		<div style="text-align: center;padding-top: 20px;">
			...
			<p style="float: left; padding: 10px">Here you can display the timetable of perticular <b>class</b> in the college.</p>
		</div>
		...
		<div class="row">
			...
			<fieldset class="col" style="padding: 35px;text-align: center; ">
				<form method="POST">
					<input id="CnamE" type="text"class="form-control"  name="class" placeholder="Enter class name"><br>
					...
					<br><br>
					<input type="submit" class="btn btn-secondary" name="submit" value="submit" id="butt">
				</form>
			</fieldset>
			<div class="col"></div>
		</div>
		<div id="hint" style="height: 50px;width: 100%">
		</div>
		<br><br><br><br>
		<br><br><br><br>

		<div class="optable" style="float: bottom;">
			<div  style="height: 50px;text-align: center;background-color: gray;">
				<p id="heading"></p>
			</div>
	...
	var clname=document.getElementById("CnamE");
	var hint=document.getElementById("hint");
	var butt=document.getElementById("butt");
	

	butt.addEventListener("mousedown",changes);
	var ch =document.createElement("P");		


	function changes(e){
		ch.innerText="Scroll down to see the Time Table.";
		hint.appendChild(ch);
		console.log(e.type);
		heading.innerHTML=clname.value;
